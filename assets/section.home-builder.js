(function($){
	...
	theme.HomeBuilder = (function() {
		...
		function HomeBuilder(container) {
			...
			this.$container.on('section.unload', function () {
				_.onUnload();
			});

			this.$container.on('section.load', function () {
				_.onLoad();
			});
			...
			this.$container.on('section.reload', function () {
				_.onUnload();
				_.onLoad();
				_.$container.trigger('section:reloaded');
			});
		};
		...
		HomeBuilder.prototype = $.extend({}, Section.prototype, HomeBuilder.prototype, {
			...
			onUnload: function() {
				...
				this.$container.trigger('section:unloaded');
			}
		});
